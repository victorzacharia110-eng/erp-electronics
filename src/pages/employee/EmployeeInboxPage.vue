...
.message-bubble.mine { background: #27ae60; color: #fff; align-self: flex-end; padding-right: 30px; }
.msg-delete-btn { position: absolute; top: 6px; right: 6px; width: 24px; height: 24px; border-radius: 50%; border: none; background: rgba(255,255,255,0.9); color: #27ae60; cursor: pointer; display: flex; align-items: center; justify-content: center; font-size: 11px; opacity: 0; transition: opacity 0.15s; }
.message-bubble.mine:hover .msg-delete-btn { opacity: 1; }
.msg-delete-btn:hover { background: #27ae60; color: #fff; }
